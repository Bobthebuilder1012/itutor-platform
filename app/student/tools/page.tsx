...
const TOOLS = [
  ...
  {
    name: 'Formula Sheet',
    desc: 'CSEC Physics, Mathematics & reference material',
    icon: BookOpen,
    tint: 'bg-brand-soft',
    iconColor: 'text-brand-deep',
    href: '/student/tools/formulas',
    comingSoon: false,
  },
  {
    name: 'Pomodoro Timer',
    desc: 'Reactive focus sessions that adapt to your study rhythm',
    icon: Clock,
    tint: 'bg-peach',
    iconColor: 'text-ink',
    href: '/student/tools/pomodoro',
    comingSoon: false,
  },
  {
    name: 'Flashcards',
