    ...
    <div className={`border-2 rounded-lg p-4 transition-all ${
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <label className="relative inline-flex items-center cursor-pointer">
          ...
          />
          <div className="relative w-11 h-6 bg-gray-300 rounded-full peer transition-colors duration-200 ease-in-out peer-checked:bg-green-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:h-5 after:w-5 after:rounded-full after:bg-white after:border after:border-gray-300 after:transition-[transform,border-color] after:duration-200 after:ease-in-out peer-checked:after:translate-x-full peer-checked:after:border-white"></div>
