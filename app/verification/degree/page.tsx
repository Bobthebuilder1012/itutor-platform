...
export default function VerificationDegreePage() {
  ...
  const showForm = !degree || degree.status === 'rejected';

  return (
    <DashboardLayout role={layoutRole(profile.role)} userName={getDisplayName(profile)}>
      <div className="max-w-lg mx-auto px-4 py-8">
        <Link href="/verification" className="text-sm text-indigo-600 hover:text-indigo-800 mb-6 inline-block">
          ← Verification
        </Link>

        <h1 className="text-2xl font-bold text-gray-900">Degree credentials</h1>
