-- ============================================================
-- 175_fix_calendar_busy_periods_scope.sql
-- ============================================================
-- Migration 173's second SELECT referenced busy_periods outside
-- the WITH block where it was defined — PostgreSQL raises
-- "relation busy_periods does not exist".
-- Fix: give the second SELECT its own CTE for busy_periods.
-- ============================================================
...
BEGIN
    ...
    -- ── Busy blocks (own CTE so busy_periods is in scope) ────────────────────
