-- The bookings trigger `notify_on_booking_request` already creates the
-- detailed booking request notification. This older RPC overload also created
-- a generic notification, which caused duplicate in-app rows and duplicate
-- push fan-out attempts for the same booking.
...
CREATE OR REPLACE FUNCTION public.create_booking_request(
  ...
  p_student_notes text DEFAULT ''::text,
  p_price_ttd numeric DEFAULT NULL::numeric,
...
BEGIN
  ...
  IF NOT v_tutor_allows_same_day THEN
