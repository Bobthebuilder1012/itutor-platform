-- ============================================================
-- MIGRATION 211: 'secure_spot_lapsed' NOTIFICATION TYPE
-- ============================================================
-- Sent when a secured place is released after the grace window, so a student
-- is never dropped from a class in silence a month after paying for it.
--
-- All 60 existing values re-listed (the 57 originals plus the three added in
-- 209), read back off the database rather than recalled, and verified
-- afterwards to still be present.
-- ============================================================
