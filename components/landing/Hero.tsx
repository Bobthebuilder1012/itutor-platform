  ...
  return (
    <section className="relative bg-gradient-to-br from-white via-green-50 to-emerald-50 pt-44 pb-20 sm:pt-52 md:pt-60 lg:pt-64 sm:pb-28 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 -left-20 w-96 h-96 bg-gradient-to-br from-itutor-green/30 to-emerald-400/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 -right-20 w-96 h-96 bg-gradient-to-br from-emerald-400/30 to-green-300/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-itutor-green/10 to-emerald-200/10 rounded-full blur-3xl"></div>
      </div>
