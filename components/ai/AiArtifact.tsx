...
export default function AiArtifact({
  ...
  onStartOver: () => void;
  /**
   * False when the artifact is embedded as a chat header rather than shown as
   * the result of a run. 'Start over' has nothing to start over from there, and
   * the caveat is already carried by the composer underneath.
   */
  showActions?: boolean;
}) {
