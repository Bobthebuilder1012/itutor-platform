          ...
          <div className="bg-white rounded-[14px] p-6 shadow-[0_4px_14px_rgba(0,0,0,0.06)] border border-gray-200">
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1 hidden md:block border-l border-gray-100 pl-5">
                <p className="text-[10px] font-bold uppercase tracking-[.08em] text-slate-400 mb-2.5">Quick Actions</p>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <button key={qa.label} onClick={qa.action}
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg border border-gray-200 text-[12.5px] font-medium text-gray-700 hover:border-emerald-400 hover:text-emerald-700 hover:bg-emerald-50 transition-colors">
                      <svg className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>{qa.icon}</svg>
                      {qa.label}
                    </button>
                  ))}
                </div>
